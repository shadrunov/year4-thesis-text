...
\image{imagespull.pdf}{Images distribution by number of pulls}{img:imagespull}{0.7}

\image{imagesdistro.pdf}{Images per Linux distribution}{img:imagesdistro}{0.7}
